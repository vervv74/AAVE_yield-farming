...
(async () => {
    ...
    gas = await mycontract.estimateGas.borrow(process.env.AAVEpool, process.env.USDT, ethers.BigNumber.from('550000'));
    receipt = await mycontract.borrow(process.env.AAVEpool, process.env.USDT, ethers.BigNumber.from('550000'), {
