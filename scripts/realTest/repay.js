...
(async () => {
    ...
    gas = await mycontract.estimateGas.repayFull(process.env.AAVEpool, process.env.USDT);
    receipt = await mycontract.repayFull(process.env.AAVEpool, process.env.USDT, {
